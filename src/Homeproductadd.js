...
const Homeproductadd = ({navigation, Screen}) => {
  ...
  const postData = async () => {
    if (
      ...
      try {
        await firestore().collection('homedetail').add({
          name,
          price,
          year,
          disc,
  ...
  return (
    <KeyboardAvoidingView
      ...
      <ScrollView>
        <Text style={{fontSize: 30, margin: 20}}>Home Product Detail</Text>
