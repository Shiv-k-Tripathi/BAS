...
const Eletronicadd = ({navigation, Screen}) => {
  ...
  const postData = async () => {
    if (
      ...
      try {
        await firestore().collection('electricdetail').add({
          name,
          price,
          year,
          disc,
  ...
  return (
    ...
    <ScrollView>
      <Text style={{fontSize: 30, margin: 20}}>Eletronic Item Detail</Text>
